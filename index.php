...
<br>
<button type="button" class="save" style="font-size:12pt;height:30px;width:130px;" onClick="window.location.reload();">save data</button> <br><a id="results">[ <img src="https://icons.iconarchive.com/icons/flat-icons.com/square/16/save-icon.png"> สำรองข้อมูล ]</a>
</form>
...
if (uptrend === true){
  ...
  document.getElementById("market"+cryptoCoin[i].toLowerCase()).innerHTML = '<center>'+'ขาขึ้น'.fontcolor("#108F3A")+'</center>'
} else if (uptrend === false){
  document.getElementById("market"+cryptoCoin[i].toLowerCase()).innerHTML = '<center>'+'ขาลง'.fontcolor("red")+'</center>'
}
